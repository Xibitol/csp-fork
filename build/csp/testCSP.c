...
int test_core_constraint_accessors(int, char*[]);
int test_core_constraint(int, char*[]);
int test_core_init_finish_1(int, char*[]);
int test_core_init_finish_2(int, char*[]);
int test_core_init_finish_3(int, char*[]);
int test_core_problem(int, char*[]);
int test_solver_constraint_to_check(int, char*[]);
int test_solver_problem_is_consistent(int, char*[]);
...
CM_LOCAL const functionMapEntry cmakeGeneratedFunctionMapEntries[] = {
    {
    "test/core/constraint-accessors",
    test_core_constraint_accessors
  },
  {
    "test/core/constraint",
    test_core_constraint
  },
  {
    "test/core/init-finish-1",
    test_core_init_finish_1
  },
  {
    "test/core/init-finish-2",
    test_core_init_finish_2
  },
  {
    "test/core/init-finish-3",
    test_core_init_finish_3
  },
  {
    "test/core/problem",
    test_core_problem
  ...
  {
    "test/solver/constraint-to-check",
    test_solver_constraint_to_check
  },
  {
    "test/solver/problem-is-consistent",
    test_solver_problem_is_consistent
  },
